...
model=${MODEL:-"hf_models/Qwen3-4B"}
bsz=${BSZ:-48}
seq=${SEQ:-1}
lr=${LR:-1e-5}
steps=${STEPS:-300}
...
dataset=${DATASET:-"public_data/qwen_mix_sft_64K6"}
dataset_cache_dir="public_data/data_cache"
...
export SWANLAB_API_KEY="key"
export SWANLAB_PROJECT="project"
